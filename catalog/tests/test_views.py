...
# Required to grant permission to set book as returned
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        # check the initial date for the form, must be three weks in the future
    def test_form_renewal_date_initially_has_date_three_weeks_in_future(self):
        ...
        # check that the view redirects to list of all borowed books
